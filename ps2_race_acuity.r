...
#identify covariates- delete acuity, outcomes, and race
...
for (i in 1:length(methods)) {
    ...
    p <- ggplot(ors, aes(y = race, x = estimate)) +
        ...
        labs(title="Effect of race on likelihood of being triaged as urgent (ESI 1-2)", subtitle=paste0(method_names[i], ", relative to white people"), x = "Odds Ratios (95% CI)", y="") +
        theme_minimal() +
