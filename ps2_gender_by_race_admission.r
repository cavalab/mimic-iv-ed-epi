...
for (i in 1:length(methods)) {
    ...
    p <- ggplot(ors, aes(y = race, x = estimate)) +
        ...
        labs(title="Effect of being male on likelihood of being admitted, by race", subtitle=paste0(method_names[i], ", relative to women of same race"), x = "Odds Ratios (95% CI)", y="") +
        theme_minimal() +
