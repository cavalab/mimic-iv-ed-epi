...
for (i in 1:length(methods)) {
    ...
    p <- ggplot(ors, aes(y = age, x = estimate)) +
        ...
        labs(title="Effect of age on likelihood of being triaged as urgent (ESI 1-2)", subtitle=paste0(method_names[i], ", relative to 18-29 year olds"), x = "Odds Ratios (95% CI)", y="") +
        theme_minimal() +
